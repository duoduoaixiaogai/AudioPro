...
//        void Resample(int rate, ProgressDialog *progress = NULL);
    ...
    * calculations and Contrast */
        ...
        void SetDisplayRect(const QRect& r) const;
        void GetDisplayRect(QRect* r);
    ...
    * function to tell the envelope about it. */
        ...
        void AppendAlias(const QString &fName, sampleCount start,
                         size_t len, int channel,bool useOD);

        void AppendCoded(const QString &fName, sampleCount start,
